...
class Clippy(commands.Cog):
    ...
    # Clippy Slash Command
    @app_commands.command(name="clippy", description="You should run this command. Can I help?")
    @app_commands.describe(text="What should Clippy say?")
    @app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
    @app_commands.user_install()
    async def clippy(self, interaction: discord.Interaction, text: str):
        ...
        text = Nullify.resolve_mentions(text,ctx=interaction,escape=False,channel_mentions=True)
        ...
        while True:
            ...
            await interaction.followup.send(file=discord.File(fp='images/clippynow.png'))
            # Remove the png

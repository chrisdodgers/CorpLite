...
## Lyrics
####	Lyrics Cog (1 command) - Lyrics.py Extension:
	  $lyrics (AKA: lyric)
...
## Settings
####	Settings Cog (15 commands) - Settings.py Extension:
	  $addowner [member]
